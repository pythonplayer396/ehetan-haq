    ...
    <div className={className}>
      ...
      {value ? (
        <div className="relative group">
          <img src={value} alt="Preview" className="w-full h-40 rounded object-cover border border-border" />
        ...
        <button
          ...
          disabled={uploading}
          className="w-full h-32 rounded border-2 border-dashed border-border hover:border-primary/50 bg-muted/30 flex flex-col items-center justify-center gap-2 transition-colors cursor-pointer disabled:opacity-50"
        >
          {uploading ? (
            ...
            <>
              ...
              <span className="text-sm text-muted-foreground">Click to upload image or GIF</span>
            </>
          )}
        </button>
      )}
